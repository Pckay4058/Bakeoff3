...
void draw()
{
  ...
  if (startTime!=0 & isPicking == false)
  {
    //buttonLogic();
    ...
    fill(15, 255, 237, 45);
    rect(340, 340, 30, 120, 2, 0, 0, 6);
    
    textAlign(CENTER);
    fill(200);
    textFont(createFont("Arial", 16));
    text("b.c.d.f", 400, 358);
    text("g.h.j.k", 400, 382);
    text("l.m.n.p", 400, 406);
    text("q.r.s.t.v", 400, 430);
    text("w.x.y.z", 400, 454);
    ...
    //rotate(radians(-90));
  } else if(startTime!=0 & isPicking == true)
  {
    textAlign(LEFT); //align the text left
    fill(128);
    text("Phrase " + (currTrialNum+1) + " of " + totalTrialNum, 70, 50); //draw the trial count
    ...
    //rotate(radians(90));
    if(currentIndex == 3){
      text("" + alphabet[currentIndex][0], 386, 382); //draw current2 letter
      text("" + alphabet[currentIndex][2], 386, 406);
      text("" + alphabet[currentIndex][4], 400, 430);
      
      text("" + alphabet[currentIndex][1], 415, 382); //draw current2 letter
      text("" + alphabet[currentIndex][3], 415, 406);
      //text("" + alphabet[currentIndex][5], 415, 430);
    } else {
      text("" + alphabet[currentIndex][0], 386, 388); //draw current2 letter
      text("" + alphabet[currentIndex][2], 386, 425);
      //text("" + alphabet[currentIndex][4], 386, 430);
      
      text("" + alphabet[currentIndex][1], 415, 388); //draw current2 letter
      text("" + alphabet[currentIndex][3], 415, 425);
      //text("" + alphabet[currentIndex][5], 415, 430);
    }
...
void mousePressed()
{
  if(isPicking==false & startTime!=0){
    //width/2-sizeOfInputArea/2, height/2-sizeOfInputArea/2, sizeOfInputArea, sizeOfInputArea/2
    if (didMouseClick(370, 340, 60, 24)) //Top1
    {
      currentIndex = 0;
      isPicking = true;
    }
    if (didMouseClick(370, 364, 60, 24)) //mid1
    {
      currentIndex = 1;
      isPicking = true;
    }
    if (didMouseClick(370, 388, 60, 24)) //bottom1
    {
      currentIndex = 2;
      isPicking = true;
    }
    if (didMouseClick(370, 412, 60, 24)) //bottom1
    {
      currentIndex = 3;
      isPicking = true;
    }
    if (didMouseClick(370, 436, 60, 24)) //bottom1
    {
      currentIndex = 4;
      isPicking = true;
    }
    
  } else if(isPicking==true & startTime!=0){
    if (didMouseClick(370, 340, 30, 24)) //bottom1
    {
      currentIndex--;
      if(currentIndex<0){
        currentIndex=4;
    ...
    if (didMouseClick(400, 340, 30, 24)) //bottom1
    {
      currentIndex++;
      if(currentIndex>4){
        currentIndex=0;
    ...
    if(currentIndex == 3){
      if (didMouseClick(370, 364, 30, 24))
      {
        currentTyped+=alphabet[currentIndex][0];
      }
      if (didMouseClick(400, 364, 30, 24))
      {
        currentTyped+=alphabet[currentIndex][1];
      }
      if (didMouseClick(370, 388, 30, 24))
      {
        currentTyped+=alphabet[currentIndex][2];
      }
      if (didMouseClick(400, 388, 30, 24))
      {
        currentTyped+=alphabet[currentIndex][3];
      }
      if (didMouseClick(370, 412, 60, 24))
      {
        currentTyped+=alphabet[currentIndex][4];
      }
    } else{
      if (didMouseClick(370, 364, 30, 36))
      {
        currentTyped+=alphabet[currentIndex][0];
      }
      if (didMouseClick(400, 364, 30, 36))
      {
        currentTyped+=alphabet[currentIndex][1];
      }
      if (didMouseClick(370, 400, 30, 36))
      {
        currentTyped+=alphabet[currentIndex][2];
      }
      if (didMouseClick(400, 400, 30, 36))
      {
        currentTyped+=alphabet[currentIndex][3];
      }
    }
  ...
  if (didMouseClick(340, 340, 30, 24)) //a
  {
    currentTyped+='a';
  }
  if (didMouseClick(340, 364, 30, 24)) //a
  {
    currentTyped+='e';
  }
  if (didMouseClick(340, 388, 30, 24)) //a
  {
    currentTyped+='i';
  }
  if (didMouseClick(340, 412, 30, 24)) //a
  {
    currentTyped+='o';
  }
  if (didMouseClick(340, 436, 30, 24)) //a
  {
    currentTyped+='u';
  }
